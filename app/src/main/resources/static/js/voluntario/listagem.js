    ...
    functions: {
        ...
        table: {
            ...
            construirLinhas: (voluntarios) => {
                ...
                voluntarios.forEach(voluntario => linhasTabela += listagemVoluntarios.functions.table.construirLinha(voluntario));
                ...
                return `
                    <tr id="voluntario-item-list">
                        ...
                        <td class="">${voluntario.telefone}</td>
                         <td class="">${voluntario.cao}</td>
                        <td class=" text-center">
                            <a class="icon-link icon-link-hover" href="${urlVoluntarios}/templatePDF" style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);">
        ...
        pagination: {
            ...
            onError: (jqXHR, textStatus, errorThrown) => {
                ...
                let message = "Falha ao carregar a listagem de voluntários";
            ...
            onSuccess: (data, pagination) => {
                if (!data.length) {
                    ...
                    let message = "Nenhum voluntário cadastrado";
